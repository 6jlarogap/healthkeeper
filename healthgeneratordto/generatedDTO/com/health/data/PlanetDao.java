...
public class PlanetDao extends AbstractDao<Planet, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property PlutonRise = new Property(18, java.util.Date.class, "PlutonRise", false, "PLUTON_RISE");
        public final static Property PlutonSet = new Property(19, java.util.Date.class, "PlutonSet", false, "PLUTON_SET");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'tblplanet' (" + //
                ...
                "'PLUTON_RISE' INTEGER," + // 18: PlutonRise
                "'PLUTON_SET' INTEGER);"); // 19: PlutonSet
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, Planet entity) {
        ...
        java.util.Date PlutonRise = entity.getPlutonRise();
        if (PlutonRise != null) {
            stmt.bindLong(19, PlutonRise.getTime());
        }
 
        java.util.Date PlutonSet = entity.getPlutonSet();
        if (PlutonSet != null) {
            stmt.bindLong(20, PlutonSet.getTime());
        }
    }
    ...
    public Planet readEntity(Cursor cursor, int offset) {
        Planet entity = new Planet( //
            ...
            cursor.isNull(offset + 18) ? null : new java.util.Date(cursor.getLong(offset + 18)), // PlutonRise
            cursor.isNull(offset + 19) ? null : new java.util.Date(cursor.getLong(offset + 19)) // PlutonSet
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Planet entity, int offset) {
        ...
        entity.setPlutonRise(cursor.isNull(offset + 18) ? null : new java.util.Date(cursor.getLong(offset + 18)));
        entity.setPlutonSet(cursor.isNull(offset + 19) ? null : new java.util.Date(cursor.getLong(offset + 19)));
     }
