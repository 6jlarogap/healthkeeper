 ...
 */
public class Arthritis1 extends Dependency {
    ...
    public void buildDependincies() {
        ...
        for(Date dt : result.keySet()){
            if(result.get(dt) != null){
                insertBodyFeeling(daoSession, dt, 34L, 5L);
                insertBodyFeeling(daoSession, dt, 35L, 34L);
                insertBodyFeeling(daoSession, dt, 40L, 17L);
                insertBodyFeeling(daoSession, dt, 41L, 7L);
            }
        }
    }
