...
public class HelioPhysicsType extends ParameterType {
    ...
    public static final int OPTICAL_FLARES_1_TYPE = 5005;
    public static final int OPTICAL_FLARES_2_TYPE = 5006;
    public static final int OPTICAL_FLARES_3_TYPE = 5007;
    public static final int OPTICAL_FLARES_S_TYPE = 5008;
    public static final int XRAY_FLARES_C_TYPE = 5009;
    public static final int XRAY_FLARES_M_TYPE = 5010;
    public static final int XRAY_FLARES_X_TYPE = 5011;
    public static final int XBKGD_TYPE = 5012;
