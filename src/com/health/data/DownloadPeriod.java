...
public class DownloadPeriod {
    ...
    public static final Date MIN_DATE = new Date(115, 0, 1);
    public static final Date NOW_DATE = new Date();
    public static final Date MAX_DATE = new Date(NOW_DATE.getTime() + 31*24*60*60*1000L);
    public static final long DEFAULT_DOWNLOAD_PERIOD_SEC = 10 * 86400L;
    public static final long START_PERIOD_UNIX_TIME = MIN_DATE.getTime()/1000L; //2015-01-01
    public static final long END_PERIOD_UNIX_TIME = (new Date()).getTime()/1000L + DEFAULT_DOWNLOAD_PERIOD_SEC;

    public static final int COMMON_DATA_TYPE = 1;
    public static final int USER_DATA_TYPE = 2;

    public static final int START_RESULT = 0;
