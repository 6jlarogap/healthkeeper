...
public class OperationUserData {
    ...
    public static void deleteOperationUserData(String rowId){
    	DaoSession daoSession = DB.db().newSession();
    	List<OperationUserData> dbList = daoSession.getOperationUserDataDao().queryBuilder().where(OperationUserDataDao.Properties.RowId.eq(rowId)).list();
    	for(OperationUserData op : dbList){
    		daoSession.getOperationUserDataDao().delete(op);
    	}        
    }
