...
public class PlanetType extends ParameterType {
    ...
    public static final double TYPE_MIN_BORDER = 0;
    public static final double TYPE_MAX_BORDER = 24D * 60D * 60D * 1000D;
    public static final double TYPE_STEP = 10800000d;
