...
public class WeatherType extends ParameterType {
    ...
    public static final double PRESSURE_TYPE_MIN_BORDER = 690;
    public static final double PRESSURE_TYPE_MAX_BORDER = 790;
    public static final double PRESSURE_TYPE_STEP = 20;
    public static final double TEMPERATURE_TYPE_MIN_BORDER = -50;
    public static final double TEMPERATURE_TYPE_MAX_BORDER = 50;
    public static final double TEMPERATURE_TYPE_STEP = 10;
    public static final double HUMIDITY_TYPE_MIN_BORDER = 0;
    public static final double HUMIDITY_TYPE_MAX_BORDER = 120;
    public static final double HUMIDITY_TYPE_STEP = 20;
    public static final double CLOUD_TYPE_MIN_BORDER = 0;
    public static final double CLOUD_TYPE_MAX_BORDER = 120;
    public static final double CLOUD_TYPE_STEP = 20;
    public static final double PRECIPITATION_MIN_BORDER = 0;
    public static final double PRECIPITATION_MAX_BORDER = 20;
    public static final double PRECIPITATION_STEP = 4;
    public static final double WINDSPEED_MIN_BORDER = 0;
    public static final double WINDSPEED_MAX_BORDER = 20;
    public static final double WINDSPEED_STEP = 4;
