...
public class User {
    ...
    public static final long  ANONIM_USER_ID = BaseDTO.INT_NULL_VALUE;
    public static final String  ANONIM_LOGIN = "qwertyuioplkjhgfdsazxcvbnm";
    public static final String  ANONIM_PASSWORD = "qwertyuioplkjhgfdsazxcvbnm";
    public static final long  ANONIM_USER_CITY_ID = 625144;

    public static final int  IS_ACTIVE = 1;
    public static final int  IS_PASSIVE = 0;

    public static final String LOGIN_COLUMN_NAME = "Login";
    public static final String IS_ACTIVE_COLUMN_NAME = "IsActive";
    public static final String IS_STOREPASSWORD_COLUMN_NAME = "IsStorePassword";

    public static final int ANONIM_SEX = 0;
    ...
    public void generateLogin(){
        String login = null;
        if(this.FName != null && this.LName != null && this.MName != null && this.BirthDate != null){
            SimpleDateFormat sdf = new SimpleDateFormat(BaseDTO.DATE_FORMAT);
            String birthDateString = sdf.format(this.BirthDate);
            login = String.format("%s_%s_%s_%s", this.LName.toUpperCase(), this.FName.toUpperCase(), this.MName.toUpperCase(), birthDateString);
        }
        this.Login = login;
    }
    ...
    public String getFullName(){
        String fName = this.FName != null ? this.FName : "";
        String mName = this.MName != null ? this.MName : "";
        String lName = this.LName != null ? this.LName : "";
        return String.format("%s %s %s", lName, fName, mName);
    }

    public boolean isAskPassword(){
        return !(IsStorePassword == 1);
    }

    public boolean isAnonim(){
        return this.Sex == User.ANONIM_SEX;
    }
    // KEEP METHODS END
