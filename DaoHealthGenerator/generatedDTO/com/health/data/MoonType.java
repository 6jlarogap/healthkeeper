...
public class MoonType extends ParameterType {
    ...
    public static final double MOON_TYPE_MIN_BORDER = -10800000d;
    public static final double MOON_TYPE_MAX_BORDER = 97200000d;
    public static final double MOON_TYPE_STEP = 21600000d;
